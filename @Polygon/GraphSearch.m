function [OpenList,ClosedList,A,index_list,type_list,path_list,FingerMatrix,pathwayMatrix] = GraphSearch(PG,cont,nodes,start_node,f1,f2,graphfig)
% Inputs:
% PG is the polygon
...
if ~connect
    ...
    intercept = interceptv(interceptInd(1),:);
    if size(intercept,1)>1
        disp('error');
    end
end
