...
% [Open_list,Closed_list,A,index_list,type_list,path_list,FingerMatrix,pathwayMatrix] = GraphSearchNoGraphics(PG,cont,nodes,start_node,f1,f2);
...
% 
% [~,BGdepth,~] = plotResults_pathPositionsNew(PG,nodes,Closed_list,index_list,type_list,path_list,basepos,[])
% close all
