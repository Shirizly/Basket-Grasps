function segment = equisigmaSegment(PG,s1init,s2init,theta0,prevedge)
segment = [];
syms t
...
%             end
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        segment = {dsf,[theta0prev,theta0],[edge1;edge2],[s1prev,s2prev],[s10,s20]};
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        segment = {dsf,theta0,[edge1;edge2],[Sv(1),Sv(end)],[s1prev,s2prev],[s10,s20]};
    end
